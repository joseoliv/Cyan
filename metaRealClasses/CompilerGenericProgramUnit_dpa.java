...
public class CompilerGenericProgramUnit_dpa implements ICompilerProgramUnitLater_dpa {
	...
	public void addToListAfter_afti(CyanMetaobject annotation) {
		compiler.addToListAfter_afti(annotation);
	}
