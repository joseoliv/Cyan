...
public class CompilerAction_dpa implements ICompilerAction_dpa {
	...
	public List<List<String>> getGenericPrototypeArgListList() {
		final ProgramUnit pu = compiler.getCurrentProgramUnit();
	...
	public String getCurrentPrototypeId() {
		if ( compiler.getCurrentProgramUnit() != null ) {
			return compiler.getCurrentProgramUnit().getSimpleName();
		}
		else
			return null;
	}
	...
	public void errorAtGenericPrototypeInstantiation(String errorMessage) {
		final CompilationUnit cunit = compiler.getCurrentProgramUnit().getCompilationUnit();
		if ( cunit == null ) {
		...
		final ProgramUnit programUnitInstantiation = compiler.searchPackagePrototype(packageNameInstantiation, prototypeNameInstantiation);
	...
	@Override
	public WrProgramUnit searchPackagePrototype(String packageNameInstantiation,
			String prototypeNameInstantiation) {
		ProgramUnit pu = compiler.searchPackagePrototype(packageNameInstantiation, prototypeNameInstantiation);
	...
	public WrEnv getEnv() {
		...
		env.setCurrentProgramUnit(compiler.getCurrentProgramUnit());
