...
public class SymbolCyanAnnotation extends Symbol {
	 ...
	 * @param postfix is parsing, AF_RES_TYPES, or SEM_AN. If it is "AF_RES_TYPES", for example, and the metaobject name, annotationName,
	...
	/**
	 * the metaobject name may be postfixed by postfix.getName() which is "parsing", "AF_RES_TYPES", "SEM_AN", or "cge".
	 */
