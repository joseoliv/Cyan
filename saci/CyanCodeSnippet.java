...
public class CyanCodeSnippet {
	 ...
	 */
	public Object evalCyanCode(String cyanCode, Object selfObject,
			         String cyanLangDir_param, String []varNameList, Object []objList
			         ) {
		...
		*/
    	project = new Project( program, null, null,
    	...
    	try {
        	wrEvalEnv = new WrEvalEnv(this.cyanLangDir,
    			    			 selfObject, null);
    		final CyanPackage cyanPackage = new CyanPackage(this.program, "anonymousPackage",
    				 this.project, "anonymousPackage", null, null, null);
    		...
    		final List<WrStatement> statList = parseCyanCodeShell(cp);
    		if ( statList.size() == 0 ) { return null; }
    		final Tuple2<Object, String> t = evalCyanCode(statList, wrEvalEnv, varNameList, objList);
    		if ( t == null ) {
    			RuntimeException rte = new cyanruntime.ExceptionContainer__(
    					new _ExceptionStr( new CyString("Exception when evaluating Cyan statements. Probably an internal error")) );
    			throw rte;
    		}
    		else if ( t.f2 != null ) {
    			throw new cyanruntime.ExceptionContainer__(
    					new _ExceptionStr( new CyString(t.f2)) );
    		}
    		else  {
    			return t.f1;
    		}
	...
	private static Tuple2<Object, String> evalCyanCode(List<WrStatement> statList,
			WrEvalEnv ee, String []varNameList, Object []objList) {
		if ( statList.size() == 0 ) { return null; }

		if ( (varNameList == null && objList != null) || (varNameList != null && objList == null) ) {
			final Tuple2<Object, String> t = new Tuple2<Object, String>(null,
		...
		for ( final WrStatement is : statList ) {
			try {
				...
				final Tuple2<Object, String> t =
						new Tuple2<Object, String>(null,
								"Error in line " + sym.getLineNumber() + "(" + sym.getColumnNumber() + "): " + e.getMessage());
				return t;
			}
			catch( ReturnValueEvalEnvException e) {
				final Tuple2<Object, String> t = new Tuple2<Object, String>(ee.getReturnValue(), null);
				return t;
			}
			catch ( final Throwable e ) {
				final Tuple2<Object, String> t =
						new Tuple2<Object, String>(null,
								"An exception was thrown by statement of line " +
						   is.getFirstSymbol().getLineNumber() + "(" + is.getFirstSymbol().getColumnNumber() +
						   ")");
				return t;
			}

		}
		final Tuple2<Object, String> t = new Tuple2<Object, String>(null, null);
		return t;
	}
						...
						try {
							...
							if ( m != null ) {
								...
								try {
									...
									return "Error when calling method 'setVisible' of an object of class " + objClass.getCanonicalName();
								}
							}
						}
									...
									if ( m != null ) {
										...
										try {
											...
											break;
												...
												| InvocationTargetException e) {
											return "Error when calling method " + setVisibleMethodName + " of an object of class " + objClass.getCanonicalName();
										}
									}
								}
								catch (NoSuchMethodException | SecurityException | IllegalArgumentException e) {
