...
import cyan.lang._Array_LT_GP__Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT__GT;
import cyan.lang._Array_LT_GP__meta_p_ISlotSignature_GT;
...
import cyan.lang._Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT;
...
//			for ( AnnotationAt packAnnot : this.getCompilationUnit().getCyanPackage().getAttachedAnnotationList() ) {
...
//
//			/*
//			 * if the metaobject annotation has a suffix greater or equal to "AF_RES_TYPES" then the actions below
//			 * have already been taken (the compiler changed the suffix to "AF_RES_TYPES" or greater) or
//			 * they should not be taken (the original program uses a suffix in the metaobject annotation
//			 * of "AF_RES_TYPES" or greater).
//			 */
//			if ( cyanAnnotation.getPostfix() == null ||
//					cyanAnnotation.getPostfix().lessThan(CompilerPhase.AF_RES_TYPES) ) {
//
...
//
		...
		for ( Annotation annot : metaobjectAnnotationList ) {
			...
			if ( annot.getPostfix() != null &&
				 !annot.getPostfix().lessThan(CompilerPhase.AF_RES_TYPES) ) {
				continue;
			}
				...
				try {
					if ( other == null ) {
						codeSlot = ((IAction_afterResTypes ) cyanMetaobject)
								.afterResTypes_codeToAdd(compiler_afterResTypes, null);
					}
					else {
...
//										new _Array_LT_GP__Tuple_LT_GP_Object_GP__Array_LT_GP_Object_GT__GT__GT());
						_Tuple_LT_GP_CyString_GP_CyString_GT t = ((_IAction__afterResTypes ) other)
								._afterResTypes__codeToAdd_2(compiler_afterResTypes,
										new _Array_LT_GP__Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT__GT());
					...
					if ( codeSlot == null ) {
						...
						if ( cyanMetaobject instanceof IAction_afterResTypes )  {
							if ( ((IAction_afterResTypes ) cyanMetaobject).runUntilFixedPoint() ) {
								env.error(annot.getFirstSymbol(), "Method to generate code in phase AF_RES_TYPES of " +
					...
					else
					{
						...
						if ( cyanMetaobject instanceof IAction_afterResTypes ) {
							...
							if ( ((_IAction__afterResTypes ) other)._runUntilFixedPoint() ) {
								if ( runManyList == null ) {
									runManyList = new ArrayList<>();
								}
								runManyList.add(t);
	    		...
	    		for ( Tuple4<Annotation, StringBuffer, List<ISlotSignature>, String>
    				...
    				try {
    					...
    					if ( other == null ) {
    						...
    						_Array_LT_GP__Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT__GT x;

    						_Array_LT_GP__Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT__GT arrayTuple =
    								new _Array_LT_GP__Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT__GT();
...
//    								new _Array_LT_GP__Tuple_LT_GP_Object_GP__Array_LT_GP_Object_GT__GT__GT();
    						...
    						if ( infoList != null ) {
        						for (Tuple2<WrAnnotation, List<ISlotSignature>>  t : infoList ) {
        							_Array_LT_GP__meta_p_ISlotSignature_GT arraySlot = new _Array_LT_GP__meta_p_ISlotSignature_GT();
//        							_Array_LT_GP_Object_GT arraySlot = new _Array_LT_GP_Object_GT();
        							for ( ISlotSignature slotInter : t.f2 ) {
        								arraySlot._add_1(slotInter);
        							}
        							// _Tuple_LT_GP__meta_p_WrCyanAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT
        							arrayTuple._add_1(
        									new _Tuple_LT_GP__meta_p_WrAnnotation_GP__Array_LT_GP__meta_p_ISlotSignature_GT__GT(t.f1, arraySlot)
        									);
...
//
	...
	*/
	 ...
	 * phase AF_RES_TYPES. These are the types of metaobject annotations
	 */
