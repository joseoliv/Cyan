...
public class TypeJavaClass extends TypeJavaRef {
	...
	public TypeJavaClass(String className, JVMPackage jvmPackage) {
...
//			}
	...
	@Override
	public WrType getI() {
		if ( iTypeJavaClass == null ) {
			iTypeJavaClass = new WrTypeJavaClass(this);
		}
		return iTypeJavaClass;
	}

	private WrTypeJavaClass iTypeJavaClass = null;
}
