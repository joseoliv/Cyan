 ...
 * (of metaobject classes that implement {@link ICommunicateInPrototype_afti_dsa_afsa}) made
 * in the same prototype can share information
 *
 * @author José
 */
public interface ICommunicateInPrototype_afti_dsa_afsa {
	 ...
	 * that is one of the elements returned by method {@link #afti_dsa_afsa_receiveInfoPrototype(HashSet)}.
	   @return
	 */
	 ...
	 * If the annotation of the metaobject is in a prototype <code>P</code>, this method
	   ...
	   The information returned by method {@link #afti_dsa_afsa_shareInfoPrototype()} of the metaobject is
 ...
 *
	 * @param 	annotationInfoSet	 Every tuple in this set correspond to an annotation of a metaobject.
		 ...
		 * by {@link #afti_dsa_afsa_shareInfoPrototype()}.
	 */
	@SuppressWarnings("unused")
