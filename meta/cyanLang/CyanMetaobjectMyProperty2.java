...
public class CyanMetaobjectMyProperty2  extends CyanMetaobjectAtAnnot implements IAction_afterResTypes {
	...
	Tuple2<StringBuffer, String> afterResTypes_codeToAdd(
		...
		String methodSet = "    func " + methodNameSet + ": " + ivTypeName + " other";

		methodsSignature.append(methodGet + ";\n");
		methodsSignature.append(methodSet + " ;");

		methodsCode.append(methodGet + " = " + name + ";\n");
		methodsCode.append(methodSet +
				" { self." + name + " = other; }\n");
		return new Tuple2<StringBuffer, String>(methodsCode, methodsSignature.toString());
