...
public interface ICompiler_dsa extends IAbstractCyanCompiler  {
	...
	/**
	 * remove the code of statement 'stat' and replace it by code.
	 * This is being asked by metaobject annotation 'annotation'.  The type of code is
	 * codeType.
	 */
