...
public interface IActionAttachedType_dsa {

	/**
<p>This method is called whenever:</p>
<ul>
<li>a type <code>T</code> has an attached metaobject whose class <code>C</code> implements interface <code>IActionAttachedType_dsa</code> and;</li>
 ...
 */
	...
	default StringBuffer dsa_checkLeftTypeChangeRightExpr(
...
<p>The string returned by this method replaces the expression <code>rightExpr</code>.<br>
	...
	@SuppressWarnings("unused")
	default StringBuffer dsa_checkRightTypeChangeRightExpr(ICompiler_dsa compiler_dsa,
			WrType leftType, Object leftASTNode, LeftHandSideKind leftKind,
			WrType rightType, WrExpr rightExpr) {
		return null;
	}
