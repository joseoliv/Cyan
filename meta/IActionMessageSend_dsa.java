 ...
 * This interface is similar to {@link meta.IActionMethodMissing_dsa}. It is only
 * used when a method for a message send WAS FOUND at compile-time. The metaobject
 * annotation should be attached to a method.
   @author jose
 */
public interface IActionMessageSend_dsa extends IStayPrototypeInterface {
	...
	default Tuple3<StringBuffer, String, String> dsa_analyzeReplaceKeywordMessage(
	 ...
	 * However, method dsa_analyzeReplaceUnaryMessage is called when
	 * there is a receiver as in
	 *          x = self unaryMethod;
	 */
	@SuppressWarnings("unused")
	default Tuple3<StringBuffer, String, String> dsa_analyzeReplaceUnaryMessage(
	 ...
	 */
	@SuppressWarnings("unused")
	default Tuple3<StringBuffer, String, String> dsa_analyzeReplaceUnaryMessageWithoutSelf(
