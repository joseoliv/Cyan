...
/**
 * This interface should be implemented by all metaobjects that should add code at phase afti and that should
 * be attached to a program unit or inside a program unit.
   @author José
 */
public interface IAction_afti {
...
<pre><code>    [. &quot;&quot;&quot;var Int count = 0;
	...
	default Tuple2<StringBuffer, String> afti_codeToAdd(
			...
			List<ISlotInterface>>> infoList) { return null; }
	...
	default List<Tuple3<String, StringBuffer, Boolean>> afti_beforeMethodCodeList(
			ICompiler_afti compiler) { return null; }
	...
	default List<Tuple2<String, String []>> afti_renameMethod(
			ICompiler_afti compiler_afti) { return null; }
