 ...
 * This interface is similar to {@link meta.IActionMethodMissing_dsa}.
 * The annotation should be attached to a method or a prototype
   @author jose
 */

public interface IActionMethodMissing_dsa extends IStayPrototypeInterface {
	...
	default Tuple3<StringBuffer, String, String> dsa_missingKeywordMethod(
	 ...
	 */
	@SuppressWarnings("unused")
	default Tuple3<StringBuffer, String, String> dsa_missingUnaryMethod(
				WrExpr receiver, WrSymbol unarySymbol, WrEnv env) {
		return null;
	}

}
//  dsa_analyzeReplaceMessageWithkeywords    dsa_missingKeywordMethod
//  dsa_analyzeReplaceUnaryMessage           dsa_missingUnaryMethod
